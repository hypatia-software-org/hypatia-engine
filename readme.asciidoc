= Hypatia: 2D tile-based adventure game engine
...
Please read the https://github.com/lillian-lemmer/hypatia/wiki/Installation-Instructions[Installation Instructions] on the wiki.
