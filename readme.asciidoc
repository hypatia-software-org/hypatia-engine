...
For more details please read the wiki's https://github.com/lillian-lemmer/untitled-game-engine/wiki/Current-Features[current features page] and https://github.com/lillian-lemmer/untitled-game-engine/wiki/Planned-Features[planned features page] or check out the _examples_ section below.
